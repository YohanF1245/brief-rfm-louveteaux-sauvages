...
SELECT
    ...
    f.boss_percentage AS boss_percentage,
    ...
    fp.player_name AS player_name,
    dim.player_guid AS player_guid,
    dim.class_name AS class_name,
    pi.spec_id AS spec_id,
    pi.avg_item_level AS avg_item_level,
    gf.role AS role,
    coalesce(gf.is_guild_member, 0) AS is_guild_member,
    gf.player_guild_name AS player_guild_name,
